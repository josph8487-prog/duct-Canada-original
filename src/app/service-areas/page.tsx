...
<section className={styles.hero}>
   ...
   <h1 className={styles.heroTitle} style={{ fontSize: '24px', fontWeight: '700', whiteSpace: 'normal', lineHeight: '1.2', wordWrap: 'break-word', marginTop: '140px' }}>
           Areas We Serve

        </h1>

        <p className={styles.heroSubtitle} style={{ fontSize: 'clamp(0.95rem, 3.5vw, 1.1rem)', fontWeight: '400', opacity: 0.9, marginTop: '0px', whiteSpace: 'normal' }}>
